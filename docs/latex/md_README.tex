...
\href{https://www.stereolabs.com/developers/release}{\texttt{ ZED SDK}}\textbackslash{} \href{https://wiki.ros.org/}{\texttt{ ROS}} packages\hypertarget{md_README_autotoc_md2}{}\doxysection{Hardware}\label{md_README_autotoc_md2}
Stereo\+Labs ZED 2i Stereo Camera \href{https://www.stereolabs.com/products/zed-2}{\texttt{ \mbox{[}link\mbox{]}}}\hypertarget{md_README_autotoc_md3}{}\doxysection{Calibration}\label{md_README_autotoc_md3}
...
{\bfseries{Note\+:}} The interpolator used above for calibration does not perform collision checking!\hypertarget{md_README_autotoc_md4}{}\doxysection{Perception Pipeline}\label{md_README_autotoc_md4}
